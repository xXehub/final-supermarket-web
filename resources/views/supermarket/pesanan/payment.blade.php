                                ...
                                <select class="form-select @error('metode_pembayaran') is-invalid @enderror"
                                    ...
                                    @foreach ($metode_pembayaran as $metode)
                                        <option value="{{ $metode->metode_pembayaran }}">
                                            {{ $metode->metode_pembayaran }}</option>
                                    @endforeach
                                </select>
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            ...
                            <button type="submit" href="{{ route('pesan') }}" class="btn btn-primary d-none d-sm-inline-block">
                            ...
                            <button type="submit" href="{{ route('pesan') }}" class="btn btn-primary d-sm-none btn-icon"
