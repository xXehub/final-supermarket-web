<form id="keranjangForm" action="{{ route('keranjang.tambah') }}" method="POST">
    @csrf
    @method('POST')
    <div class="modal modal-blur fade" id="modal-tambahKeranjang" tabindex="-1" role="dialog" aria-hidden="true"
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="jumlah" value="1"> </input>
                                @error('jumlah')
                ...
                <div class="modal-footer">
                    ...
                    <div class="col-auto ms-auto d-print-none">
                        <div class="btn-list">
                            ...
                            <button type="submit" class="btn btn-primary d-sm-none btn-icon" id="keranjangButton">
                                <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round">
