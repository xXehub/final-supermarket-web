                            ...
                            <div class="card-body">
                                <div class="datagrid">
                                    ...
                                    <div class="datagrid-item">
                                        ...
                                        <div class="datagrid-content">{{ $detail_pemesanan->produk_id }}</div>
                                    </div>
                                    <div class="datagrid-item">
                                        ...
                                        <div class="datagrid-content">
                                            <div class="d-flex align-items-center">
                                                <span class="avatar avatar-xs me-2 rounded"
                                                    style="background-image: url('{{ asset('/storage/produk/' . $pemesanan->user->gambar_profile) }}')"></span>
                                                {{ $pemesanan->user->name }}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="datagrid-item">
                                        ...
                                        <div class="datagrid-content">{{ 'Rp ' . number_format($detail_pemesanan->subtotal, 0, ',', '.') }}</div>
                                    </div>
