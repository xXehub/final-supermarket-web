      ...
      <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
          <div class="container-fluid">
              ...
              <h1 class="navbar-brand navbar-brand-autodark">
                  <a href=".">
                      <img src="./static/logo.svg" width="110" height="32" alt="Gudang Rempah"
      ...
      {{-- script gawe navbar active --}}
      <script>
        // Ambil URL yang sedang diakses
        const currentUrl = window.location.href;
        // Ambil semua elemen <li> pada sidebar
        const sidebarItems = document.querySelectorAll('#sidebar-menu .nav-item');
        // Iterasi setiap elemen <li>
        sidebarItems.forEach((item) => {
          // Ambil URL menu dari atribut href pada elemen <a>
